/**
 * Move backgrounds/level_01_* into backgrounds/level_01/ (preserves .meta UUIDs).
 * Run from cocos/: node tools/migrate-level01-backgrounds.js
 */
const fs = require('fs');
...
const files = [
  'level_01_start.jpg',
  'level_01_loop.png',
  'level_01_scene_03_bridge.jpg',
  'level_01_scene_03_loop.jpg',
  'level_01_scene_04_bridge.jpg',
  'level_01_scene_04_loop.jpg',
];
...
console.log(`level_01 backgrounds migrated: ${moved} files`);
